...
let projectList = [
  { id: 1, title: 'To-Do App', url: 'https/url', urlGit: 'https://bwierzba.github.io/to-do-app/', description: `WORK IN PROGRESS // Aplikacja do zapisywania zadań do wykonania, z możliwością odchaczania wykonanych zadań oraz dodawania deadline'u` },
  ...
  { id: 6, title: 'Architecture Studio', url: 'https/url', urlGit: 'https://bwierzba.github.io/etn/', description: 'WORK IN PROGRESS // Projekt nad którym pracuję - strona wizytówka studia projektowania architektury' },
]
